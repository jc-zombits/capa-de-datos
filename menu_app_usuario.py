...
while opcion != 5:
    ...
    opcion = int(input('Escribe la opción que deseas (1 - 5): '))
    ...
    if opcion == 1:
        ...
        id_usuario_var = int(input('Ingresa el id del usuario a actualizar: '))
        ...
        id_usuario_var = int(input('Ingresa el id del usuario a eliminar: '))
